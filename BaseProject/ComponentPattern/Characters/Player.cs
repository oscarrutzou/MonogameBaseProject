...
public class Player : Component, ISubject
{
    ...
    public override void Start()
    {
        ...
        sr.SetLayerDepth(LayerDepthTypes.Player);
    ...
    public void Move(Vector2 velocity)
    {
        ...
        this.velocity = Vector2.Lerp(this.velocity, targetVelocity, turnSpeed * GameWorld.DeltaTimeF);
        GameObject.Transform.Translate(this.velocity * speed * GameWorld.DeltaTimeF);
